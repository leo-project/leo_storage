    ...
    {ok, [
          ...
          {watchdog,
           [{cpu_enabled,    ?env_watchdog_cpu_enabled(leo_storage)},
            ...
            {rex_interval,   ?env_watchdog_rex_interval(leo_storage)},
            {cpu_interval,   ?env_watchdog_cpu_interval(leo_storage)},
            {io_interval,    ?env_watchdog_io_interval(leo_storage)},
            {disk_interval,  ?env_watchdog_disk_interval(leo_storage)},
